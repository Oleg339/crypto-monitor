...
// 15000 (а не дефолтные 5000): домашний роутер даёт WAN-стойлы, из-за которых
// подписанный запрос приходит на биржу с задержкой и отбраковывается как
// просроченный (bybit 10002). Больший recv_window терпит доставку до ~15 с.
